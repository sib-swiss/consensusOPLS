...
method. This analysis concerned a selection of data from a publicly available repository of the National Cancer Institute, i.e. the NCI-60 dataset. This data set provides experimental data obtained from 60 human cancer cell lines derivated from nine tissus origins [@SHOEMAKER2006]. Two tissus were selected in this study: colon versus ovary.
The data were divided into 3 blocks, evaluated on the same observations:
...
ggplot2::ggplot(data = data_two_plots,
                aes(x = factor(Type), y = Values, fill = Blocks)) +
  ggplot2::geom_bar(stat = 'identity') + 
  ggplot2::xlab("Data blocks") +
  ggplot2::ylab("Weight") +
