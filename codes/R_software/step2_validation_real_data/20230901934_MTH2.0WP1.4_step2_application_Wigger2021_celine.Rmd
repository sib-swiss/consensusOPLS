...
```{r QRcode_Matlab}
path_logo <- "../../../communication/presentations/" 
...
# Lire le logo
logo <- image_read(paste0(path_logo, "RFMF/", "Matlablogo.png"))
...
# Chemin de l'image
path_img_theo <- "C:/Users/cbougel/Desktop/20230901934_MTH2.0WP1_task4_copie/communication/presentations"
...
# Lire le logo
logo <- image_read(paste0(path_img_theo, "/Logos/", "Logo_Excel.png"))
...
# Sauvegarder l'image finale
image_write(qr_inverted, 
            path = paste0(path_img_theo, "/", "QRcode_Excel_SansLogo.png"), 
            format = "png")
image_write(qr_with_logo, 
            path = paste0(path_img_theo, "/", "QRcode_Excel.png"), 
            format = "png")
```
...
# Lire le logo
logo <- image_read(paste0(path_img_theo, "/Logos/", "Logo_Peak_Forest.png"))
...
# Sauvegarder l'image finale
image_write(qr_inverted, 
            path = paste0(path_img_theo, "/", "QRcode_Peak_Forest_SansLogo.png"), 
            format = "png")
image_write(qr_with_logo, 
            path = paste0(path_img_theo, "/", "QRcode_Peak_Forest.png"), 
            format = "png")
```
...
# Lire le logo
logo <- image_read(paste0(path_img_theo, "/Logos/", 
                          "image_QR-removebg-preview.png"))
...
# Sauvegarder l'image finale
image_write(qr_inverted, 
            path = paste0(path_img_theo, "/", "QRcode_Baptiste_sansLogo.png"), 
            format = "png")
image_write(qr_with_logo, 
            path = paste0(path_img_theo, "/", "QRcode_Baptiste.png"), 
            format = "png")
```
...
# Sauvegarder l'image finale
image_write(qr_inverted, 
            path = paste0(path_img_theo, "/", "QRcode_Baptiste_2_sansLogo.png"), 
            format = "png")
image_write(qr_with_logo, 
            path = paste0(path_img_theo, "/", "QRcode_Baptiste_2.png"), 
            format = "png")
```
...
# Compute the VIP
Optimal_model_no_perm <- COPLS_res$optimal
