...
VIP <- data.frame(VIP = c(COPLS_res@VIP$rna, COPLS_res@VIP$lipids, COPLS_res@VIP$sphingolipids), variable = c(names(COPLS_res@VIP$rna), names(COPLS_res@VIP$lipids), names(COPLS_res@VIP$sphingolipids)))
